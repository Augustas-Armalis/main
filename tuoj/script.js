...
const bounceFactor = 0.8; // Bounce effect multiplier
...
function endDrag() {
  ...
  if (formFlexBasis >= 87) {
    ...
    targetHeight = formFlexBasis + (velocity * bounceFactor * 5); // Adjust for bounce effect, reversed
  }
  ...
  const inertiaInterval = setInterval(() => {
    ...
    targetHeight += velocity * bounceFactor; // Apply inverted inertia, reversed direction
