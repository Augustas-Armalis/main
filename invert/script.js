...
function startDrag(e) {
  // Prevent default behavior to avoid any scrolling or jumping
  e.preventDefault();
...
function onDrag(e) {
  ...
  // Prevent scrolling and ensure touch events do not interfere
  e.preventDefault();

  const currentY = e.touches ? e.touches[0].clientY : e.clientY;

  const dy = currentY - startY; // Fixed: Change in Y position (dragging down or up)
