...
function startDrag(e) {
  ...
  // Debugging logs
  console.log("Start Y:", startY); // Debugging line
  console.log("Start Height:", startHeight); // Debugging line
...
function onDrag(e) {
  ...
  const dy = currentY - startY; // Change in Y position (current - start)
  const newHeight = startHeight - dy; // Subtract dy from startHeight

  // Debugging log
  console.log("Current Y:", currentY, "DY:", dy, "New Height:", newHeight); // Log current position and change
