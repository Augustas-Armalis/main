...
function startDrag(e) {
  ...
  // Get the bounding rect of the drag line to calculate offset
  const dragLineRect = dragLineContainer.getBoundingClientRect();
  offsetY = touchY - dragLineRect.top; // Calculate the offset of the touch point
...
function onDrag(e) {
  ...
  // Use the offset to calculate the new height based on the current touch position
  const newHeight = startHeight + (startY - (currentY - offsetY)); // Use offsetY to prevent jumping
